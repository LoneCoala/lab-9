       ...
       int rowIndex2;
        ...
        public void LoadData()
        {
            ...
            try
            {
                ...
                sqlDataAdapter = new SqlDataAdapter("SELECT *, 'Delete' AS [Delete] FROM Test", sqlConnection);
        ...
        private void toolStripButton4_Click(object sender, EventArgs e)
        {
                ...
                {
                    SqlCommand commanddel = new SqlCommand($"DELETE FROM Test WHERE Id={Convert.ToString(dataSet.Tables["Test"].Rows[rowIndex]["id"])}", sqlConnection);
