                    ...
                    if (resultSName == false)
                    {
                        ...
                        if (resultName == false)
                        {
                            ...
                            if (resultMName == false)
                            {
                                ...
                                SqlCommand command = new SqlCommand($"INSERT INTO Test (Фамилия, Имя, Отчество, Телефон) VALUES(N'{textBox1.Text}', N'{textBox2.Text}', N'{textBox3.Text}', '{textBox4.Text}')", sqlConnection);
